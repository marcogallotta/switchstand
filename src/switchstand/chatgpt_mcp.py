...
def build_chatgpt_server(service: ChatGPTService, server: MCPServer | None = None) -> MCPServer:
    ...
    async def work_attachments(
        ...
        """List attachment evidence for one explicitly authorized WorkId."""
    ...
    async def work_attachment(
        ...
        """Read one opaque attachment identity for one explicitly authorized WorkId."""
        return await service.attachment(WorkAttachmentRequest(
